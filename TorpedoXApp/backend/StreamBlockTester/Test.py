...
def main():
    ...
    try:
        with open(log_filename, 'w') as log_file:
            subprocess.run(
                ["python", r"D:\TorpedoX\TorpedoXApp\backend\StreamBlockTester\o1_Extract.py", temp_filename, feature_filename],
                check=True,
    ...
    model_filename = r"D:\TorpedoX\TorpedoXApp\backend\StreamBlockTester\random_forest_model.pkl"
    try:
